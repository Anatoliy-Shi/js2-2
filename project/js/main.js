class ProductList {
    ...
    constructor(container = '.products') {
        ...
        this.#fetchGoods();
        this.#render();
         //   метод который считает сумму товаров.
        this.productSum()
        console.log(this.productSum(this.#goods))
    }
    //   метод который считает сумму товаров.
    productSum() {
        return this.#goods.reduce((acc, item) => acc += item.price * item.quantity, 0)
    }
    ...
    render() {
        return `<div class="product-item" data-id="${this.id}">
              ...
              <div class="desc">
                  <h3>${this.title}</h3>
                  <p>${this.price} \u20bd</p>
                  <h5>количество: ${this.quantity}</h5> 
